    ...
    <section id="pricing" className="py-24 relative">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            <h2 className="text-3xl md:text-4xl font-extrabold font-[family-name:var(--font-heading)] mb-8 text-white">
              Book a Call To Learn More
            </h2>
            <div className="rounded-2xl border border-[#2d4470] bg-white p-6 text-gray-900">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-xs text-gray-500 font-medium uppercase tracking-wider">Powered by Calendly</span>
              </div>
              <h3 className="text-2xl font-bold mb-4 text-gray-900">10xOps AI Demo</h3>
          ...
          <div>
            ...
            <div className="flex mb-6 bg-[#1a2844] rounded-lg p-1 max-w-xs border border-[#2d4470]">
              <button
                onClick={() => setTab('commercial')}
                className={`flex-1 px-4 py-2.5 rounded-md text-sm font-semibold transition-all ${
                  tab === 'commercial' ? 'bg-[#0e1628] text-white shadow' : 'text-[#94a3b8] hover:text-white'
                }`}
              >
                Commercial
              </button>
              <button
                ...
                className={`flex-1 px-4 py-2.5 rounded-md text-sm font-semibold transition-all ${
                  tab === 'residential' ? 'bg-[#0e1628] text-white shadow' : 'text-[#94a3b8] hover:text-white'
                }`}
              >
                Residential
              </button>
            ...
            <div className="rounded-2xl border border-[#2d4470] bg-[#152036] p-8">
              <p className="text-sm text-[#cbd5e1] mb-1">{plan.name}</p>
