    ...
    <section className="py-20 md:py-28 relative overflow-hidden bg-slate-50">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 mb-12">
        <div className="text-center">
          <h2 className="text-3xl sm:text-4xl font-extrabold font-[family-name:var(--font-heading)] text-slate-900">
      ...
      <div className="relative">
        ...
        <div className="flex gap-6 overflow-x-auto pb-4 px-6 scrollbar-hide" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none', WebkitOverflowScrolling: 'touch' }}>
          {testimonials.map((t, i) => (
            <div
              key={i}
              className="flex-shrink-0 w-[350px] sm:w-[400px] p-6 rounded-2xl bg-white border border-slate-200 shadow-sm hover:shadow-md transition-all duration-300"
            >
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-slate-100">
                <div className="w-10 h-10 rounded-full bg-blue-50 flex items-center justify-center border border-blue-100">
                  <span className="text-sm font-bold text-blue-700">{t.name.charAt(0)}</span>
                </div>
                <div>
