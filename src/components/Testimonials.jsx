      ...
      <div className="relative">
        ...
        <div className="flex gap-6 overflow-x-auto pb-4 px-6 scrollbar-hide" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none', WebkitOverflowScrolling: 'touch' }}>
          {testimonials.map((t, i) => (
            <div
              key={i}
              className="flex-shrink-0 w-[350px] sm:w-[400px] p-6 rounded-2xl bg-[#152036] border border-[#263a5e]/50 hover:border-cyan-400/30 transition-all duration-300"
            >
              ...
              <p className="text-[#a8b8cf] leading-relaxed mb-6 text-[15px]">"{t.quote}"</p>

              <div className="flex items-center gap-3 pt-4 border-t border-[#263a5e]/50">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-cyan-500/20 to-blue-500/20 flex items-center justify-center border border-[#263a5e]">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#7b8fad]">{t.role}</p>
                </div>
              </div>
            </div>
          ))}
