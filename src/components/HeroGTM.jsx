        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="animate-fade-in-up md:pr-8">
            <div className="flex flex-wrap gap-3 mb-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#1a2844] border border-[#2d4470]">
            ...
            <div className="w-full aspect-square max-w-[500px] ml-auto relative">
              <div className="absolute inset-0" style={{ clipPath: 'polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)' }}>
                <div className="grid grid-cols-2 grid-rows-2 h-full gap-1 bg-white/10 p-1">
                  <div className="bg-gradient-to-br from-cyan-500/25 to-blue-600/25 flex items-center justify-center p-4">
                    <span className="text-white/60 font-bold text-xl uppercase tracking-widest text-center">HVAC<br/>Installs</span>
                  </div>
                  <div className="bg-gradient-to-bl from-purple-500/25 to-indigo-600/25 flex items-center justify-center p-4">
                    <span className="text-white/60 font-bold text-xl uppercase tracking-widest text-center">Roofing<br/>Repairs</span>
                  </div>
                  <div className="bg-gradient-to-tr from-amber-500/25 to-orange-600/25 flex items-center justify-center p-4">
                    <span className="text-white/60 font-bold text-xl uppercase tracking-widest text-center">Plumbing<br/>Services</span>
                  </div>
                  <div className="bg-gradient-to-tl from-emerald-500/25 to-teal-600/25 flex items-center justify-center p-4">
                    <span className="text-white/60 font-bold text-xl uppercase tracking-widest text-center">Electrical<br/>Contracting</span>
                  </div>
                </div>
              </div>
              <div className="absolute -inset-4 bg-gradient-to-r from-cyan-500/15 via-blue-500/15 to-purple-500/15 rounded-full blur-3xl -z-10" />
            </div>
          </div>
